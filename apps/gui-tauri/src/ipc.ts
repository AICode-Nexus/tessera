...
function createFallbackSnapshot(): ClientSnapshot {
  return {
    ...
    approvals: [
      {
        approval_id: 'approval_web_sensitive',
        call_id: 'call_web_sensitive',
        tool_id: 'tool_web_sensitive',
        status: 'pending',
        reason: 'approval reason mentions /Users/admin/work/tessera/.env',
        required_permissions: ['private approval permission'],
        side_effects: ['private approval side effect'],
      },
      {
        approval_id: 'approval_web_resolved_one',
        call_id: 'call_web_resolved_one',
        tool_id: 'tool_web_resolved_one',
        status: 'approved',
        reason: 'approved reason remains hidden',
        required_permissions: [],
        side_effects: [],
      },
      {
        approval_id: 'approval_web_resolved_two',
        call_id: 'call_web_resolved_two',
        tool_id: 'tool_web_resolved_two',
        status: 'denied',
        reason: 'denied reason remains hidden',
        required_permissions: [],
        side_effects: [],
      },
    ],
    ...
    reviewer_gates: [
      {
        gate_id: 'gate_web_review',
        handoff_id: 'handoff_web_review',
        parent_task_id: 'task_web_workflow',
        status: 'accepted',
        requested_decisions: ['accept', 'reject', 'request_revision'],
        decision: 'accept',
        reviewer: 'private reviewer label',
        reason_code: 'private reason code',
        comment: 'reviewer private comment',
        evidence: [
          {
