...
export type ClientWorkflowInspection = { workflow_ref: string, task_ref: string, active: boolean, mutation_mode: string | null, worktree_required: boolean, patch_count: number, diff_artifact_ref_count: number, patches_requiring_review_count: number, review_bundle_count: number, review_evidence_ref_count: number, reviewer_gate_count: number, accepted_reviewer_gate_count: number, rejected_reviewer_gate_count: number, revision_requested_reviewer_gate_count: number, pending_reviewer_gate_count: number, approval_count: number, pending_approval_count: number, resolved_approval_count: number, apply_patch_preflight_count: number, executor_ready_preflight_count: number, executor_blocked_preflight_count: number, apply_patch_execution_count: number, successful_apply_patch_execution_count: number, failed_apply_patch_execution_count: number, };
...
export type ApplyPatchExecutionBlocker = "preflight_not_ready" | "executor_unavailable" | "primary_root_rejected" | "missing_checkpoint_lifecycle" | "checkpoint_not_created" | "missing_policy_decision" | "policy_not_allowed" | "missing_reviewer_decision" | "reviewer_not_accepted" | "missing_sandbox_profile" | "missing_isolated_root" | "unsafe_path" | "symlink_rejected" | "unsupported_patch_operation" | "multiple_files_unsupported" | "hunk_conflict" | "write_failed";

export type ApplyPatchExecutionId = string;

export type ApplyPatchExecutionRecord = { execution_id: ApplyPatchExecutionId, preflight_id: ApplyPatchPreflightId, workflow_id: CodingWorkflowId, task_id: TaskId, request_id: MutationRequestId, patch_id: PatchProposalId, checkpoint_id: SnapshotId | null, reviewer_gate_id: ReviewerGateId | null, policy_decision_id: PolicyDecisionId | null, sandbox_profile_label: string | null, isolated_root_label: string, executor_label: string, status: ApplyPatchExecutionStatus, blockers: Array<ApplyPatchExecutionBlocker>, affected_paths: Array<string>, conflict_paths: Array<string>, artifact_refs: Array<ArtifactId>, evidence: Array<HandoffEvidenceRef>, };

export type ApplyPatchExecutionStatus = "planned" | "applied" | "conflict" | "rejected" | "failed";
