...
- v0.7 coding workflow DTOs for workflow ids, worktree-first mutation scope, automatic worktree lifecycle metadata, patch proposal metadata, test evidence metadata, review bundles and restore plans, but only as provider-neutral metadata.
