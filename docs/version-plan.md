...
**Status:** Runtime gate foundations complete; first narrow apply-patch executor and explicit CLI envelope are implemented; trace-driven apply-patch automation is designed but not implemented.
