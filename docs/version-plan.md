...
**Status:** Runtime gate foundations complete; first narrow apply-patch executor, explicit CLI envelope, and trace-driven `tessera apply-patch --from-trace` envelope are implemented.
