...
- current child task owner bridge 只能构造 attach/detach metadata；heartbeat loop、lost-owner detection、automatic reattach 和 provider execution 必须留给 runtime gate。
