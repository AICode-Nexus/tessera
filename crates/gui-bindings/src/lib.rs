...
use tessera_protocol::{
    ...
    ApprovalId, ArtifactBodyRecord, ArtifactBodyRedactionStatus, ArtifactId, ArtifactKind,
    ClientInstanceId, CodingWorkflowEvidenceRedactionStatus, CodingWorkflowId, ContextId,
    CostEstimate, EventId, EventRange, HandoffEvidenceKind, HandoffEvidenceRef, ItemId,
    MemoryProposalId, MutationMode, MutationRequestId, MutationRequestOperationKind,
    MutationRequestProposal, MutationRequestStatus, PatchApplicationOutcome,
