...
UI-neutral intent and projection model shared by TUI and future GUI shells. It owns slash-command intent parsing for `/new`, `/save`, and `/export`, plus markdown projection export.
