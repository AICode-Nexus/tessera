...
v0.1 exposes `tessera doctor --json`, `tessera init`, one-shot `tessera chat --provider mock --prompt ...`, and interactive `tessera chat --provider mock` on top of `tessera-core`.
