...
tessera agent run --provider mock --goal "review this task" --skill skill_reviewer --workspace .
...
tessera skills inspect --workspace .
tessera agent run --config ./tessera.toml --provider offline --goal "review this task" --skill skill_reviewer --workspace .
...
- No tool execution.
- No tool-using, executable-skill, default/global-skill, or background agent runtime beyond explicit no-tool `agent run` context loading.
- No app-server listener, remote control port, daemon, provider-through-server execution, or background process survival.
